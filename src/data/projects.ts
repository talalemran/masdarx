...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "أوبنتو - Ubuntu",
    nameEn: "Ubuntu",
    description: "توزيعة لينكس شائعة ومدعومة من Canonical، تتميز بسهولة الاستخدام ومجتمعها الكبير، وتوفر بيئة سطح مكتب GNOME افتراضياً مع دعم طويل الأمد للتحديثات والأمان. تُعد Ubuntu من أكثر التوزيعات استخداماً على أجهزة الكمبيوتر المحمولة والمكتبية، وتوفر تجربة مستخدم سلسة من أول تشغيل دون الحاجة لإعدادات معقدة، مع دعم شامل للبرامج والألعاب والأدوات الاحترافية. تأتي بإصدارات مختلفة تناسب الاحتياجات المتنوعة: من نسخة المكتب التقليدية إلى نسخة السيرفرات ونسخة IoT للأجهزة الذكية، مع توافق كامل مع الأجهزة الحديثة وتعريفاتها.",
    url: "https://github.com/canonical/ubuntu",
    website: "https://ubuntu.com",
    category: "توزيعات لينكس",
    language: "Various",
    stars: "7k+",
    license: "GPL-2.0",
    tags: ["توزيعة", "لينكس", " GNOME", "مبتدئين"],
    thumbnail: "/images/ubuntu.webp",
    features: [
      "بيئة سطح مكتب GNOME افتراضية توفر تجربة مستخدم حديثة وسلسة من أول تشغيل",
      "مكتبة برامج Ubuntu Snap وAPT توفر آلاف التطبيقات المثبتة بنقرة واحدة",
      "دعم طويل الأمد مع إصدارات LTS توفر تحديثات أمان لمدة 5 سنوات",
      "مجتمع ضخم ومستندات شاملة تسهل حل المشاكل والتعلم للأمانئيل الجدد",
    ],
    useCases: ["التعلم", "التطوير", "بيئة سطح المكتب"],
  },
];