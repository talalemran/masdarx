...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "أوبنتو - Ubuntu",
    nameEn: "Ubuntu",
    description: "توزيعة لينكس شائعة ومدعومة من Canonical، تتميز بسهولة الاستخدام ومجتمعها الكبير، وتوفر بيئة سطح مكتب GNOME افتراضياً مع دعم طويل الأمد للتحديثات والأمان.",
